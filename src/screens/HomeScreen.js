      ...
      {/*{this.props.user.email}*/}
          ...
          <View style={styles.InputContainer}>
            <TextInput
              ...
              onChangeText={text => this.setState({ telefone_lider: text })}
      ...
      {/*{this.props.user.email}*/}
          ...
          <View style={styles.InputContainer}>
            <TextInput
              style={styles.body}
              placeholder="Nome completo"
              onChangeText={text => this.setState({ nome_eleitor: text })}
          ...
          <View style={styles.InputContainer}>
            <TextInput
              style={styles.body}
              placeholder="Telefone"
              onChangeText={text => this.setState({ telefone_eleitor: text })}
          ...
          <View style={styles.InputContainer}>
            <TextInput
              ...
              onChangeText={text => this.setState({ endereco_eleitor: text })}
          ...
          <View style={styles.InputContainer}>
            <TextInput
              ...
              onChangeText={text => this.setState({ num_eleitor: text })}
          ...
          <View style={styles.InputContainer}>
            <TextInput
              style={styles.body}
              placeholder="Bairro"
              onChangeText={text => this.setState({ bairro_eleitor: text })}
          ...
          <View style={styles.InputContainer}>
            <TextInput
              ...
              onChangeText={text => this.setState({ secao: text })}
